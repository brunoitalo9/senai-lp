...
insert into estadio(nome, endereco, capacidade) values
('Estadio Antônio Accioly','Av. Perimentral, Setor Campinas - Goiânia, Goiás', 12500),
('Estádio Heriberto Hülse','Rua Treze de Maio, s/n 1947, 46 - Comerciario, Criciúma-SC', 19225),
('Estádio Alfredo Jaconi', 'R. Hércules Galló, 1547 - Centro, Caxias do Sul - RS', 19924),
('Estádio Manoel Barradas(Barradão)', 'R. Artêmio Castro Valente,1 - Canabrava, Salvador - BA',30618 );
...
update time set id_estadio = 21  where id_time = 1;
