...
values('1010','Dr. João Silva','(11)92345-6789','Pediatria'),
	('1020','Dr. Maria Oliveira','(71)98765-4321','Pediatria'),
    ('1030','Dr Carlos Santos ','(21)91234-5678','Pediatria');
...
values ('Eliana','1234567890','Rua das Flores,100,São Paulo,SP','(11)91234-5678	','1973-11-22'),
    ...
    SELECT 
    bebe.nome as "Nome",
    bebe.dt_nascimento as "Data Nascimento",
    peso as "Peso",
    altura as "Altura",
